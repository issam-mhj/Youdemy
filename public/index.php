...
Route::get('/profCourses/deleted', [teacherController::class, 'deleteCourse']);
Route::get('/profCourses/edit', [teacherController::class, 'showEdit']);
...
Route::post('/mycourses/modifyCourse', [teacherController::class, 'modifyCourse']);
